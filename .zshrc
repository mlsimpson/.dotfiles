...
plugins=(ssh-agent zsh-syntax-highlighting pass git fuck zsh-autosuggestions obliquestrategies colorize fast-syntax-highlighting zsh-completions fzf) # fzf-tab F-Sy-H
# Debian
...
####
# setopt
setopt glob globdots pushdminus multios extendedglob braceccl inc_append_history
